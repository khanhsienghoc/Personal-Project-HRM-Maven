...
public class GlobalConstants {
    ...
    public static final String UNMATCHED_CONFIRM_PASSWORD = "Passwords do not match";
    // --- Database ---
...
//    public static final String TESTING_ADMIN_PASSWORD ="admin123";
    public static final String TESTING_ADMIN_USERNAME = System.getProperty("username");
    public static final String TESTING_ADMIN_PASSWORD = System.getProperty("password");
}
